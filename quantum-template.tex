...
Quantum offers a Jupyter notebook with plotting functionality that is tailored to the quantumarticle document class that can be found in the GitHub repository.
