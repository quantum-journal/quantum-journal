...
This class supports the \texttt{unpublished} option which disables all Quantum related branding such as the logo, color, and hyperlink in the title. It can be used for works not yet accepted in Quantum.
