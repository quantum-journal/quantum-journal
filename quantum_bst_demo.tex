...
\subsection{Reference classes \texttt{mastersthesis} and \texttt{phdthesis}}\label{sec:mastersthesis}
...
% \citetests{article_trailing_comma}

Directly from the arxiv~\citetests{hubregtsen2021training}, arxiv via Zotero~\citetests{hubregtsen2021training_2}, some more testcases~\citetests{holevo2012quantum,Holevo_2012,akers2020simple,katariya2021geometric,katariya2021geometric_2,jain2010guaranteed}
